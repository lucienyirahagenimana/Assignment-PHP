...
if(isset($_POST['signup01'])) {
    ...
    if(mysqli_num_rows($res) != 0) {
        ...
        if($user['is_verified']) {
            ...
            header('location:signup02.php'); 
        } else {
            $error = "Account not verified, check your email to verify";
        }
        ...
        <div class="border-2 shadow p-1 pt-5 pb-3 mb-5 mt-5">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" class="m-2">
                ...
                <div class="row mt-2">
                    <div class="col ">
                        <div class="position-relative">
                            <button name="signup01" type="submit" class="btn btn-info rounded-pill w-100 text-white" role="button">Next</button>
